...
with h5py.File('white_slice.hdf5', 'w') as f:
	for i in range(N_chirps):
		...
		tr_chirp_slice_arr[i] = white_chirp.crop(t_inject-durn-seg/2., white_chirp.duration-t_inject-durn+seg/2.)
		#pylab.plot(tr_chirp_slice_arr[i])
		#pylab.title('tr_chirp_slice')
		#pylab.show()
		# Save white slices to dataset
		name = "white_slice"+str(i)
		dset=f.create_dataset(name, data = tr_chirp_slice_arr[i]) 
